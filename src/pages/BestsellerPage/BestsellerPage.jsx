...
const BestsellerPage = () => {
  ...
  useEffect(() => {
    const filtered = filterProducts(trendingProducts, selectedFilters);
  ...
  const resetFilters = () => {
    ...
    setFilteredCount(trendingProducts.length);
    setPreviewCount(trendingProducts.length);
    setCurrentPage(1);
  };
  ...
  return (
    <div className="bestseller-page">
      <h1 className="bestseller-page-title">Sản phẩm bán chạy nhất</h1>

      <div className="sort-bestseller">
      ...
      <section className="card-image-bestseller">
        <div className="card-grid-bestseller">
      ...
      <div className="result-pager-bestseller">
      ...
      {showFilters && (
        <div className="search-filters-modal-bestseller">
          <div className="search-filters-content">
            ...
            <div className="filter-section">
              ...
              {openSections.types && (
                <div className="filter-options">
                  {Array.from(new Set(trendingProducts.map((p) => p.type))).map(
                    (type) => (
            ...
            <div className="filter-section">
              ...
              {openSections.artists && (
                <div className="filter-options">
                  {Array.from(
                    new Set(trendingProducts.map((p) => p.artist))
                  ).map((artist) => (
            ...
            <div className="filter-section">
              ...
              {openSections.publishYears && (
                <div className="filter-options">
                  {Array.from(
                    new Set(trendingProducts.map((p) => p.publishYear))
                  ).map((year) => (
